...
**[Personal Portfolio]** is a project which is used to showcase my projects and skills. It is also used to give a brief introduction about myself
...
```
git clone https://github.com/Chimoneg27/Personal-Portfolio.git
```
